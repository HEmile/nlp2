...
class NeuralIBM1Model_T3_coll:
    ...
    def _build_model(self):
        ...
        #s = tf.bernoulli(s) #or usage:
        #s = tf.contrib.distributions.Bernoulli(s)
        ...
        hy_yp = py_yp*s #[B,N,1,emb]*[B,N,1,1]

        h = tf.add(hy_xa, hy_yp)        # [B, N, M, emb]
        py_xa_yp = tf.reshape(
             h, [batch_size, longest_y, longest_x, self.y_vocabulary_size])


        # 2.c Marginalise alignments: \sum_a P(a|x) ((1 - s_j) * P(y|xa) + s_j * P(y|prev_y))
